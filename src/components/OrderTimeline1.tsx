...
const iconMap = {
  ...
  onWay: images.van1,          // blue truck icon
  delivered: images.hand1,     // blue delivery icon
};

const TimelineItem = ({ item, isLast }) => {
  const isRed = item.type === "received" || item.type === "onWay" || item.type === "delivered"
//   const isRed = item.type === "onWay" || item.type === "delivered";
