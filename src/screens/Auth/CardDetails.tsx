...
import CustomTextInput from "../../components/CustomTextInput"; // Optional
...
const CardDetail = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <BackHeader isBack={true} title="Card Details"  onBackPress={() => navigation.goBack()}/>
