  ...
  const Orderdetails = () => {
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <BackHeader isBack={true} title="Order Details"onBackPress={() => navigation.goBack()} />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.text1}>1x</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.text2}>$294.00</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.text2}>+1 234 5678 90</Text>
          </View>
        </View>
